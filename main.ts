...
sprites.onOverlap(SpriteKind.Player, SpriteKind.objet, function (sprite2, otherSprite) {
...
game.splash("récupérez toutes les orbes !", "")
// Ton premier objet
let objet1 = sprites.create(assets.tile`baseTransparency16`, SpriteKind.objet)
// C'est bien de lui donner une position précise avec x et y
objet1.setPosition(10, 200)
// Ton deuxième objet
let objet2 = sprites.create(assets.tile`baseTransparency16`, SpriteKind.objet)
// À placer un peu plus loin pour qu'elle aille le chercher !
objet2.setPosition(120, 45)
// Ton premier objet
let objet_3 = sprites.create(assets.tile`baseTransparency16`, SpriteKind.objet)
// À placer un peu plus loin pour qu'elle aille le chercher !
objet_3.setPosition(470, 50)
// Ton premier objet
let objet_4 = sprites.create(assets.tile`baseTransparency16`, SpriteKind.objet)
// À placer un peu plus loin pour qu'elle aille le chercher !
